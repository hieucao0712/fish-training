...
import { gfSpineFish } from '../../../../../cc-common/cc30-fishbase/Scripts/Components/Fishes/gfSpineFish';
...
export class SpineFish2024 extends gfSpineFish {
    ...
    initAnimationCacheMode(cacheMode?: any): void {
        super.initAnimationCacheMode(cacheMode);
    ...
    onHit(data: any): void {
        ...
        if (this._isHaveWounded && !this._tweenHitAction) {
            ...
            this._tweenHitAction = tween(this.node)
                ...
                .call(() => {
                    this.changeAnimationSpeed(1 / SPEED_WOUNDED);
                })
